...
public class LandingScreen {
    ...
    private final UIElement item = E(byText("First List"));
    private final UIElement options = E(byXpath("//android.widget.ImageView[@content-desc=\"More options\"]\n"));
    private final UIElement deleteButton = E(byText("Delete list"));
    private final UIElement makeSure = E(byId("android:id/button1"));
    ...
    public void isNotVisisble(){
        item.waitFor(5).untilNotVisible();
    }
}
